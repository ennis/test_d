...
template tvec2(T) { alias Vector!(T, 2) tvec2; }
template tvec3(T) { alias Vector!(T, 3) tvec3; }
template tvec4(T) { alias Vector!(T, 4) tvec4; }

alias tvec2!byte   vec2b;
alias tvec2!ubyte  vec2ub;
alias tvec2!short  vec2s;
alias tvec2!ushort vec2us;
alias tvec2!int    vec2i;
alias tvec2!int    ivec2;
alias tvec2!uint   vec2ui;
alias tvec2!long   vec2l;
alias tvec2!ulong  vec2ul;
alias tvec2!float  vec2f;
alias tvec2!float  vec2;
alias tvec2!double vec2d;

alias tvec3!byte   vec3b;
alias tvec3!ubyte  vec3ub;
alias tvec3!short  vec3s;
alias tvec3!ushort vec3us;
alias tvec3!int    vec3i;
alias tvec3!int    ivec3;
alias tvec3!uint   vec3ui;
alias tvec3!long   vec3l;
alias tvec3!ulong  vec3ul;
alias tvec3!float  vec3f;
alias tvec3!float  vec3;
alias tvec3!double vec3d;

alias tvec4!byte   vec4b;
alias tvec4!ubyte  vec4ub;
alias tvec4!short  vec4s;
alias tvec4!ushort vec4us;
alias tvec4!int    vec4i;
alias tvec4!int    ivec4;
alias tvec4!uint   vec4ui;
alias tvec4!long   vec4l;
alias tvec4!ulong  vec4ul;
alias tvec4!float  vec4f;
alias tvec4!float  vec4;
alias tvec4!double vec4d;
