...
struct Quaternion(T)
{
    public
    {
        ...
        @nogc tvec3!T toEulerAngles() pure const nothrow
        {
            tmat3!T m = cast(tmat3!T)(this);
        ...
        /// TODO: check out why we can't do is(Unqual!U == tmat3!T)
...
@nogc Quaternion!T slerp(T)(Quaternion!T a, Quaternion!T b, T t) pure nothrow
{
    ...
    tvec3!T v2 = dot(b.v, a.v * dotProduct);
    v2.normalize();
